...
ERROR_RED_DARK: Final[str] = "#FF6B5A"
ACTION_GREEN_LIGHT: Final[str] = "#0F7A3A"
ERROR_RED_LIGHT: Final[str] = "#B00020"
...
DARK = Theme(
    ...
    status_error_text=ERROR_RED_DARK,
)
...
LIGHT = Theme(
    ...
    action_primary_bg=ACTION_GREEN_LIGHT,
    action_primary_text="#FFFFFF",
    status_success_text="#006B32",
    status_error_text=ERROR_RED_LIGHT,
)
