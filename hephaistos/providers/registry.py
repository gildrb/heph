...
_BUILTIN_MODELS: list[ModelInfo] = [
    ...
    ModelInfo("gpt-5.1-codex-max", "openai-codex", "GPT-5.1 Codex Max", 128_000, 16_384, 0.005, 0.015),
    ModelInfo("gpt-5.1-codex-mini", "openai-codex", "GPT-5.1 Codex Mini", 128_000, 16_384, 0.0005, 0.0015),
    ModelInfo("gpt-5.3-codex-spark", "openai-codex", "GPT-5.3 Codex Spark", 128_000, 16_384, 0.001, 0.003),
    ...
    ModelInfo("anthropic/claude-opus-4.6", "openrouter", "Claude Opus 4.6", 200_000, 8_192, 0.015, 0.075, tags=("anthropic",)),
    ModelInfo("anthropic/claude-sonnet-4.6", "openrouter", "Claude Sonnet 4.6", 200_000, 8_192, 0.003, 0.015, tags=("anthropic",)),
    ModelInfo("anthropic/claude-sonnet-4.5", "openrouter", "Claude Sonnet 4.5", 200_000, 8_192, 0.003, 0.015, tags=("anthropic",)),
    ModelInfo("anthropic/claude-haiku-4.5", "openrouter", "Claude Haiku 4.5", 200_000, 8_192, 0.0008, 0.004, tags=("anthropic",)),

    # --- Google (via OpenRouter) ---
    ModelInfo("google/gemini-3-pro-preview", "openrouter", "Gemini 3 Pro", 1_000_000, 8_192, 0.00125, 0.005, tags=("google",)),
    ModelInfo("google/gemini-3-flash-preview", "openrouter", "Gemini 3 Flash", 1_000_000, 8_192, 0.000075, 0.0003, tags=("google",)),
    ModelInfo("google/gemini-3.1-pro-preview", "openrouter", "Gemini 3.1 Pro", 1_000_000, 8_192, 0.00125, 0.005, tags=("google",)),
    ModelInfo("google/gemini-3.1-flash-lite-preview", "openrouter", "Gemini 3.1 Flash Lite", 1_000_000, 8_192, 0.00003, 0.0001, tags=("google",)),

    # --- Qwen (via OpenRouter) ---
    ModelInfo("qwen/qwen3.6-plus:free", "openrouter", "Qwen 3.6 Plus (free)", 32_000, 8_192, 0.0, 0.0, tags=("qwen", "free")),
    ModelInfo("qwen/qwen3.5-plus-02-15", "openrouter", "Qwen 3.5 Plus", 32_000, 8_192, 0.0004, 0.0012, tags=("qwen",)),
    ModelInfo("qwen/qwen3.5-35b-a3b", "openrouter", "Qwen 3.5 35B", 32_000, 8_192, 0.0001, 0.0003, tags=("qwen",)),
    ...
    ModelInfo("z-ai/glm-5", "openrouter", "GLM-5 (OpenRouter)", 128_000, 8_192, 0.001, 0.001, tags=("zai",)),
    ModelInfo("z-ai/glm-5-turbo", "openrouter", "GLM-5 Turbo (OpenRouter)", 128_000, 8_192, 0.0001, 0.0001, tags=("zai",)),

    # --- Other (via OpenRouter) ---
    ModelInfo("stepfun/step-3.5-flash", "openrouter", "Step 3.5 Flash", 32_000, 8_192, 0.0001, 0.0003),
    ...
    ModelInfo("nvidia/nemotron-3-super-120b-a12b", "openrouter", "Nemotron 3 Super", 32_000, 8_192, 0.0002, 0.0006),
    ModelInfo("nvidia/nemotron-3-super-120b-a12b:free", "openrouter", "Nemotron 3 Super (free)", 32_000, 8_192, 0.0, 0.0, tags=("free",)),
    ModelInfo("arcee-ai/trinity-large-preview:free", "openrouter", "Trinity Large (free)", 32_000, 8_192, 0.0, 0.0, tags=("free",)),
]
