...
def shell_style_dict() -> dict[str, str]:
    ...
    return {
        ...
        "header.accent": f"bg:{palette.panel} bold fg:{palette.accent}",
        "header.error": f"bg:{palette.panel} bold fg:{palette.error}",
        "header.success": f"bg:{palette.panel} bold fg:{palette.success}",
        "header.warning": f"bg:{palette.panel} bold fg:{palette.accent}",
        ...
        "chat-area.success": f"bg:{palette.panel} bold fg:{palette.success}",
