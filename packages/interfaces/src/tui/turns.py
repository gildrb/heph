...
class _TurnHost(Protocol):
    ...
    def _handle_turn_activity(self, turn_key: str, line: str) -> None: ...
...
class TuiTurnMixin:
    ...
    def _handle_turn_error(self: _TurnHost, turn_key: str, error: str) -> None:
        if self._turn_is_visible(turn_key):
    ...
    def _run_turn(
        ...
        def on_reply(reply: str) -> None:
            self.call_from_thread(self._handle_turn_reply, turn_key, reply)
        ...
        def on_finish() -> None:
            self.call_from_thread(self._finish_background_turn, turn_key, turn_session)
