...
from heph_interfaces.tui.render_state import DirtyRegion
from heph_interfaces.tui.rich_transcript import (
    enrich_reply,
...
class TuiTranscriptMixin:
    ...
    def _refresh_status(self: _TranscriptHost) -> None:
        tui_module = sys.modules["heph_interfaces.tui"]
    ...
    def _update_focused_info_panel(self: _TranscriptHost, panel: Static) -> bool:
        ...
        self._update_static_region(
            ...
            Static,
            DirtyRegion.SIDE_PANEL,
            sys.modules["heph_interfaces.tui"]._info_panel_message_text(
