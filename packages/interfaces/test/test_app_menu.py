...
import heph_interfaces.terminal as menu
import pytest
...
def test_select_option_uses_prompt_fallback(
    ...
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", lambda _prompt="": "2")
...
def test_select_option_returns_none_for_cancel(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", lambda _prompt="": "q")
...
def test_confirm_yes(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", lambda _prompt="": "1")
...
def test_select_option_slash_exit_cancels(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", lambda _prompt="": "/exit")
...
def test_select_option_slash_quit_cancels(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", lambda _prompt="": "/quit")
...
def test_select_option_keyboard_interrupt_returns_none(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("heph_interfaces.terminal.direct_input", _raise)
