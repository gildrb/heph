...
from harness.parameters.settings import load_app_settings, load_raw_settings, save_raw_settings
from harness.privacy.release import (
...
_INSTALL_ID_PATH: Final[Path] = Path.home() / ".config" / "harness" / "install_id.json"

ANALYTICS_ENABLED_ENV: Final[str] = "HARNESS_ANALYTICS_ENABLED"
CRASH_REPORTS_ENABLED_ENV: Final[str] = "HARNESS_CRASH_REPORTS_ENABLED"
POSTHOG_TOKEN_ENV: Final[str] = "HARNESS_POSTHOG_PROJECT_TOKEN"
POSTHOG_HOST_ENV: Final[str] = "HARNESS_POSTHOG_HOST"
SENTRY_DSN_ENV: Final[str] = "HARNESS_SENTRY_DSN"
