...
from harness.chat.evidence_assessment import (
...
from harness.chat.evidence_format import evidence_refs
from harness.chat.evidence_format import excerpt as _excerpt
from harness.chat.evidence_overview import (
...
_log = get_logger("harness.chat.evidence")
_RAG_MIN_SCORE = 0.1
