...
_RECALL_SCHEDULE_REL_PATH = f".harness/{_RECALL_SCHEDULE_FILE}"
_LEGACY_RECALL_SCHEDULE_REL_PATH = f".harness/{_LEGACY_RECALL_SCHEDULE_FILE}"
...
class RecallScheduleStore:
    ...
    @property
    def _path(self) -> Path:
        return self.armory_path / ".harness" / _RECALL_SCHEDULE_FILE

    @property
    def _legacy_path(self) -> Path:
        return self.armory_path / ".harness" / _LEGACY_RECALL_SCHEDULE_FILE
