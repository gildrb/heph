...
from harness.vocab.parser import VocabCard, VocabDeck

_log = get_logger("harness.vocab.state")

_SCHEDULE_FILE = "vocab_schedule.json"
_SCHEDULE_REL_PATH = f".harness/{_SCHEDULE_FILE}"
...
class VocabScheduleStore:
    ...
    @property
    def _path(self) -> Path:
        return self.armory_path / ".harness" / _SCHEDULE_FILE
