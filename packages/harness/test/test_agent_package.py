"""Tests that the agent package imports resolve correctly."""

from __future__ import annotations

import importlib.util

import harness.agent as agent_pkg
...
class TestHarnessPackageRoot:
    """Verify the harness package root is importable."""

    def test_harness_import_root_exists(self) -> None:
