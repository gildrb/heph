...
from parameters.settings import load_app_settings, load_raw_settings, save_raw_settings
...
CRASH_REPORTS_ENABLED_ENV: Final[str] = "HEPHAION_CRASH_REPORTS_ENABLED"
POSTHOG_TOKEN_ENV: Final[str] = "HEPHAION_POSTHOG_PROJECT_TOKEN"
POSTHOG_HOST_ENV: Final[str] = "HEPHAION_POSTHOG_HOST"
SENTRY_DSN_ENV: Final[str] = "HEPHAION_SENTRY_DSN"
