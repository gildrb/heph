...
from agent.armory_tools import (
    run_create_armory,
...
from agent.material_tools import run_open_material, run_search_materials
from agent.path_safety import safe_path
from agent.shell_tools import BashResult, run_bash
...
from agent.web_tools import run_web_fetch
