...
from chat.events import MaterialOperationEvent
...
from chat.material_state import _material_operation_events
from chat.reply_repair import _MAX_INTERNAL_PASSES
from chat.titles import derive_title
from chat.turn_history import build_turn_snapshot
...
from chat.usage import save_usage

if TYPE_CHECKING:
    from chat.session import ChatSession

_log = get_logger("chat.turn_finalization")
_tracer = get_tracer("chat.turn_finalization")
_meter = get_meter("chat.turn_finalization")
