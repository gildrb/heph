...
from hephaion.tui.startup_discovery import discover_available_armories, discover_startup_armory
...
def _tui_module():
    return sys.modules["hephaion.tui"]
...
def run_tui(session: ChatSession | None = None) -> None:
    tui_module = sys.modules["hephaion.tui"]
