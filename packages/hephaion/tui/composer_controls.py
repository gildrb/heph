...
import hephaion.tui.widgets as _tui_widgets
...
from hephaion.terminal.theme_state import current_palette
from hephaion.tui.display_text import footer_hints_text as _footer_hints_text
from hephaion.tui.display_text import status_text as _status_text
...
from hephaion.tui.slash_command import tui_command_suggestions as _tui_command_suggestions
...
class _ComposerControlsHost(Protocol):
    ...
    def _focus_message(self, offset: int) -> None: ...
    ...
    def _select_inline_flow_option(self, index: int | None) -> None: ...
