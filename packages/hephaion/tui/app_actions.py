...
from hephaion.commands.session import NewCommand
from hephaion.tui.display_text import armory_home_text as _armory_home_text
from hephaion.tui.display_text import new_chat_card_text as _new_chat_card_text
from hephaion.tui.display_text import startup_card_text as _startup_card_text
from hephaion.tui.ids import COMPOSER_SELECTOR, TRANSCRIPT_SELECTOR
from hephaion.tui.routing import TuiInputRoute as _TuiInputRoute
from hephaion.tui.routing import tui_input_route as _tui_input_route
from hephaion.tui.search_screen import SearchScreen
from hephaion.tui.status import config_error as _config_error
...
class _AppActionsHost(Protocol):
    ...
    busy: bool
    completion_candidates: list[object]
    ...
    def push_screen(self, screen: object, callback: Callable[[object], None]) -> object: ...
    ...
    def _create_inline_armory(self, value: str) -> None: ...
