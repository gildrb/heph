...
from hephaion.providers.keyring_store import resolve_key as _resolve_key
from hephaion.providers.reasoning import DEFAULT_REASONING_LEVEL, normalize_reasoning_level


def resolve_key(slug: str, env_var: str = "") -> str:
    """Resolve provider keys while honoring the old runtime.engine monkeypatch target."""

    engine_module = sys.modules.get("hephaion.runtime.engine")
